...
export const GATE_PROVIDER_ID = "eris-gate";
const GATE_ACCOUNT_ISSUER = "https://eris.invalid";
...
/**
 * Clear a stale marker when a `/get-session` arrives without a gate identity:
